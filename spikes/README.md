...
Each is a **standalone `cargo run` crate**, not part of the app build. Both pin their own
...
each spike is a matrix doc in [`../docs/`](../docs); the crate is just how those numbers were
gathered. Windows-only (windows-rs 0.61, MSVC toolchain).
